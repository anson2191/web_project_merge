...
export default {
    ...
    methods: {
        ...
        changeQ: function() {
            document.getElementById('Question_number').innerHTML = this.Q[this.Qn].number;
            document.getElementById('Question_box').innerHTML = this.Q[this.Qn].content;
        },
        pressbutton: function(num) {
            ...
            if(num==0)
                this.Q[this.Qn].level0 =true;
            else if(num==1)
                this.Q[this.Qn].level1 = true;
            else if(num==2)
                this.Q[this.Qn].level2 = true;
            else if(num==3)
                this.Q[this.Qn].level3 = true;
            else if(num==4)
                this.Q[this.Qn].level4 = true;            
        },
        pagechange: function() {
            var pressure = 0;
            var i = 0;
            ...
            this.$router.push({name:"PressResult", params:{result: pressure}});
        }
    }
}
</script>